...
public class CONST {
    ...
    public static UserDTO USER2DTO = new UserDTO(2L, "coachName2", COACHOFUSER2DTO);

    public static List<CoachDTO> COACHOFUSER3DTO = new ArrayList<>(List.of(COACH1DTO, COACH2DTO));
    public static UserDTO USER3DTO = new UserDTO(3L, "coachName3", COACHOFUSER3DTO);
...
//
    ...
    public static User USER2 = new User(2L, "coachName2", COACHOFUSER2,"Здоров");

    public static List<Coach> COACHOFUSER3 = new ArrayList<>(List.of(COACH1, COACH2));
    public static User USER3 = new User(3L, "coachName3", COACHOFUSER3,  "Болен");
